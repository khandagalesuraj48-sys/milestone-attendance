...
import { Lock, User as UserIcon, ArrowRight, AlertCircle, ShieldCheck, CheckCircle2 } from 'lucide-react';
        ...
        <div className="bg-white py-8 px-6 sm:px-10 rounded-2xl border border-slate-200/90 shadow-sm">
          <div>
            <div className="mb-6 pb-4 border-b border-slate-100">
              ...
              <p className="text-xs text-slate-500 mt-0.5">Enter your existing company credentials to continue</p>
            </div>
              ...
              <div>
                ...
                <div className="relative rounded-xl shadow-xs">
                  ...
                  <input
                    ...
                    placeholder="e.g. admin or username@milestoneconsultancy.in"
